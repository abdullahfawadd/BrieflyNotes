...
export default function ComingSoonView() {
  ...
  return (
    <div className="min-h-screen bg-[#070b15] px-4 py-5 text-white md:px-8 md:py-8">
      <div className="mx-auto w-full max-w-[1200px] rounded-[28px] border border-white/20 bg-[radial-gradient(circle_at_50%_40%,rgba(79,113,255,.26),rgba(4,7,17,0.95)_62%)] shadow-[0_0_90px_rgba(103,122,255,0.1)]">
        ...
        <main className="px-4 pb-6 md:px-8 md:pb-10">
          <section className="mx-auto max-w-4xl pt-6 text-center md:pt-12">
          ...
          <section className="mx-auto mt-8 max-w-3xl rounded-2xl border border-white/10 bg-[#0c1221]/85 p-2 md:p-3">
            <form onSubmit={handleSubmit} className="flex flex-col gap-2 md:flex-row">
              ...
              <button
                type="submit"
                className="rounded-xl bg-[#bfc2eb] px-8 py-3 text-lg font-semibold text-[#191b2b] transition hover:bg-[#d0d3ff]"
              >
                Notify me
              </button>
            </form>
            <p className="pt-3 text-sm text-white/65">
              {submitted ? 'Thanks! We will notify you when we launch.' : 'Join 12,421+ learners on the waitlist.'}
            </p>
          </section>
